...
use crate::engine::shared::{AgentEvent, IncidentPhase, MessageEvent};
    ...
    Box::pin(stream! {
        ...
        match result {
            ...
            Err(e) => {
                ...
                yield Err(EngineError::Other(anyhow::anyhow!("Investigator error: {}", e)));
            }
        }
    })
}
    ...
    Box::pin(stream! {
        ...
        let analysis_text = match analysis_result {
            ...
            Err(e) => {
                ...
                yield Err(EngineError::Other(anyhow::anyhow!("Analyst error: {}", e)));
                return;
            }
        };
        ...
        match report_result {
            ...
            Err(e) => {
                ...
                yield Err(EngineError::Other(anyhow::anyhow!("Reporter error: {}", e)));
            }
        }
    })
}
