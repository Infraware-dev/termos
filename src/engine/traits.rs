...
/// - [`MockEngine`](crate::engine::adapters::MockEngine) - Returns canned responses for testing
/// - [`RigEngine`](crate::engine::adapters::RigEngine) - Native rig-rs agent using Anthropic Claude API
///
