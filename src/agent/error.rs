...
pub enum AgentError {
    ...
    /// Connection error to underlying agent
...
mod tests {
    ...
    fn test_thread_not_found() {
        let err = AgentError::thread_not_found("thread-123");
    ...
    fn test_run_not_resumable() {
        let err = AgentError::run_not_resumable("no pending interrupt");
    ...
    #[test]
    fn test_unhealthy() {
        let err = AgentError::unhealthy("connection refused");
    ...
    #[test]
    fn test_connection() {
        let err = AgentError::connection("timeout");
    ...
    #[test]
    fn test_timeout() {
        let err = AgentError::timeout("health_check");
    ...
    #[test]
    fn test_debug_impl() {
        let err = AgentError::thread_not_found("test");
