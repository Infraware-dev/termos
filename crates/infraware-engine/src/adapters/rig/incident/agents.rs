...
use crate::adapters::rig::config::RigEngineConfig;
use crate::adapters::rig::orchestrator::RigAgent;
use crate::adapters::rig::tools::{AskUserTool, DiagnosticCommandTool};
...
mod tests {
    use super::*;
    use crate::adapters::rig::incident::context::IncidentContext;
